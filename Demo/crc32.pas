...
function CalcCRC32(FileName: String): string;

implementation

//Code to Check CRC of files
function CalcCRC32(FileName: String): string;
const
...
var
  ...
  {$IF CompilerVersion < 34.0}  // lower than Delphi 10.4 Sydney
  type
    Long = record
      LoWord: Word;
      HiWord: Word;
...
begin
  ...
  {$IF CompilerVersion >= 34.0}
     result := CRC32.ToHexString;  // Für neuere Delphi-Versionen ab Delphi 10.4 Sydney.
  {$ELSE}
     Result := HextL(CRC32);
  {$ENDIF}
end;
